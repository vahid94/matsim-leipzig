...
// TODO local file usage vs encrypted (kmt)
/**
 * This analysis class requires two parameters as arguments: <br>
 * (1) the root/working directory, and <br>
 * (2) the path to your (SVN) folder containing the exported HBEFA files.
 *
 * @author rgraebe
*/
...
//			final String runDirectory = "output/it-1pct/";
			...
			throw new RuntimeException("Please set the two (run and input) directory paths. \nCheck the class description for more details. Aborting...");
		}
	}
