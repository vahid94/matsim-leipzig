...
# TODO run java analysis
pop_base_case_sim <- read.csv2(file="Y:/net/ils/matsim-leipzig/00-base-case/output_simwrapper/analysis/analysis-age-distribution/age-distribution.csv")

# read in statistics
# source : https://statistik.leipzig.de/statcity/table.aspx?cat=2&rub=2&obj=0
# TODO : put this onto shared-svn
stat_leipzig_2021 <- read.csv2(file="C:/Users/Simon/Desktop/wd/2023-07-10/age-distr-analysis/Bevölkerungsbestand_Einwohner_nach_Alter_Leipzig.csv", sep=",", header = TRUE, encoding = "UTF-8",stringsAsFactors = FALSE)
